...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Constipation", font="times 30 bold", foreground="BLack", bg='White')
        ...
        all1 = Label(root, text="LAX Syrup", font="times 20 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=400)

        allt1 = Label(root, text="     Rs. 99.99", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text="Laxitol Syrup", font="times 20 bold", foreground="Black", bg='Silver')
        all2.place(x=370, y=400)

        allt2 = Label(root, text="     Rs. 249.60", font="times 16 bold", foreground="Black", bg='Silver')
        allt2.place(x=370, y=445)

        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=390, y=485)

        image_path = r"C:\Users\Abhijit\OneDrive\Desktop\pro\prusak.jpg"
        original_image = Image.open(image_path)
        resized_image = original_image.resize((150, 160), Image.BILINEAR)  # Resize image to 200x200
        self.tkinter_image = ImageTk.PhotoImage(resized_image)
        ...
        all3 = Label(root, text=" PRUSAK 2mg ", font="times 20 bold", foreground="Black", bg='Silver')
        all3.place(x=550, y=400)

        allt3 = Label(root, text="     Rs. 290.90", font="times 16 bold", foreground="Black", bg='Silver')
