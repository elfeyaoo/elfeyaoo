...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Malaria", font="times 30 bold", foreground="BLack", bg='White')
        ...
        all1 = Label(root, text="Dr. John J19", font="times 20 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=400)

        allt1 = Label(root, text="     Rs. 186.40", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text="   Virgo13", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all3 = Label(root, text="  Malariabeat", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all4 = Label(root, text="   Malirid Ds ", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all5 = Label(root, text="   Uhniji ", font="times 20 bold", foreground="Black", bg='Silver')
