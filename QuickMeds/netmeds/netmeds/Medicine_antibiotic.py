...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Anti-Scar", font="times 30 bold", foreground="BLack", bg='White')
        ...
        self.image_label.place(x=230, y=225)  # Relocate image on the page

        all1 = Label(root, text="MEDERMA PM INTENSIVE \n OVERNIGHT SCAR Cream ", font="times 16 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=410)

        allt1 = Label(root, text="     Rs. 427.50", font="times 16 bold", foreground="Black", bg='Silver')
        allt1.place(x=230, y=475)

        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=250, y=510)

        image_path = r"C:\Users\Abhijit\OneDrive\Desktop\pro\makrsnil.jpg"
        original_image = Image.open(image_path)
        resized_image = original_image.resize((150, 160), Image.BILINEAR)  # Resize image to 200x200
        self.tkinter_image = ImageTk.PhotoImage(resized_image)
        ...
        # Display resized image
        self.image_label = Label(root, image=self.tkinter_image)
        self.image_label.place(x=560, y=225)

        all2 = Label(root, text="MARKSNIL Cream \n 10 mg ", font="times 16 bold", foreground="Black", bg='Silver')
        all2.place(x=550, y=410)

        allt2 = Label(root, text="     Rs. 590.00", font="times 16 bold", foreground="Black", bg='Silver')
        allt2.place(x=560, y=475)

        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=590, y=510)
