...
## Define a class for the Doctors Page
class DoctorsPage:
    def __init__(self, root): #init serves as a constructor and is used for initialization of objects and
                               #is automatically called when a new instance of the class is created.
                                # self is a reference to the current instance of the class,
                                 # and root is a parameter that represents the root window
                                 # to which the instance of the class belongs.
        self.root = root       #This creates an instance variable named root within the class

        # Toolbar
        toolbar = Frame(root, bg='TEAL', bd=5)# This line creates a Frame  named toolbar and places it
                                                      # inside the root window.
        new_button = Button(toolbar, text='PROFILE', bg='White', fg='Teal', height=1, width=10, font="times 12 bold")
       #button is created named as new_button with the given parameters
        new_button.pack(side=LEFT, padx=50, pady=50)
        #pad is used for spacing
        ...
        cart = Button(root, text="cart", foreground="TEAL", background="purple", font="times 15 bold", bg='White',
                      height=1, width=5)#root signifies the parent widget or window where the Button widget will be placed.
        ...
        medicine = Label(root, text="Medicines - Bones", font="times 30 bold", foreground="BLack", bg='White')
        ...
        # Second Toolbar
        toolbar = Frame(root, bg='silver', bd=5)#creates frame widget named as toolbar and root defines the parent widget
        new_button = Button(toolbar, text='PROFILE', bg='White', fg='Teal', height=1, width=10, font="times 12 bold")
        ...
        #categories variable represents a Button widget.
        ...
        # defines a variable image_path and assigns it the path to an image file named "metformin.jpeg"
        original_image = Image.open(image_path)
          # opens the image file specified by image_path using the Image.open() method from the PIL library.
        # It reads the image file and stores it in the original_image variable as a PIL Image object.
        ...
        self.tkinter_image = ImageTk.PhotoImage(resized_image)
         # creates a tkinter-compatible image object
        # Display resized image
        self.image_label = Label(root, image=self.tkinter_image)
        self.image_label.place(x=180, y=225)  # Relocate image on the page

        all1 = Label(root, text="         Hk", font="times 20 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=400)

        allt1 = Label(root, text="     Rs. 586.40", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text="   Sallaki", font="times 20 bold", foreground="Black", bg='Silver')
        all2.place(x=370, y=400)

        allt2 = Label(root, text="     Rs. 206.00", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all3 = Label(root, text="    Nveda ", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all4 = Label(root, text="   Oziva ", font="times 20 bold", foreground="Black", bg='Silver')
        all4.place(x=735, y=400)

        allt4 = Label(root, text="     Rs. 625.92", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all5 = Label(root, text="   Klobone ", font="times 20 bold", foreground="Black", bg='Silver')
    ...
    def lab(self):
        ...
        self.root.destroy()
        # Open the new page window
        from demo2 import LabTestPage  # Import the NewPage class from the second script
        root = tk.Tk()
        app = LabTestPage(root)
        root.geometry("1100x600")
        root.title('NEW_PAGE')
        root.mainloop()
