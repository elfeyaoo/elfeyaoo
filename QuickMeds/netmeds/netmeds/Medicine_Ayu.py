...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Ayurvedic Health", font="times 30 bold", foreground="BLack", bg='White')
        ...
        all1 = Label(root, text="Natural skin", font="times 20 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=400)

        allt1 = Label(root, text="     Rs. 850.60", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text="   Bold care", font="times 20 bold", foreground="Black", bg='Silver')
        all2.place(x=370, y=400)

        allt2 = Label(root, text="     Rs. 996.00", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all3 = Label(root, text="Ayuvedic Gain ", font="times 20 bold", foreground="Black", bg='Silver')
        all3.place(x=550, y=400)

        allt3 = Label(root, text="     Rs. 1112.96", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all4 = Label(root, text="    Ved-Drugs ", font="times 20 bold", foreground="Black", bg='Silver')
        all4.place(x=735, y=400)

        allt4 = Label(root, text="     Rs. 125.92", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all5 = Label(root, text="   Ved-Yug ", font="times 20 bold", foreground="Black", bg='Silver')
        all5.place(x=920, y=400)

        allt5 = Label(root, text="     Rs. 445.30", font="times 16 bold", foreground="Black", bg='Silver')
