...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Cleansers", font="times 30 bold", foreground="BLack", bg='White')
        ...
        all1 = Label(root, text="  Cetaphil", font="times 20 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=400)

        allt1 = Label(root, text="     Rs. 621.00", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text=" Minimalist", font="times 20 bold", foreground="Black", bg='Silver')
        all2.place(x=370, y=400)

        allt2 = Label(root, text="     Rs. 283.60", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all3 = Label(root, text="   Gabit ", font="times 20 bold", foreground="Black", bg='Silver')
        all3.place(x=550, y=400)

        allt3 = Label(root, text="     Rs. 532.00", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all4 = Label(root, text="   Derma", font="times 20 bold", foreground="Black", bg='Silver')
        all4.place(x=735, y=400)

        allt4 = Label(root, text="     Rs. 300.50", font="times 16 bold", foreground="Black", bg='Silver')
        allt4.place(x=735, y=445)

        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=755, y=485)

        image_path = r"C:\Users\Abhijit\OneDrive\Desktop\pro\skinkraft.jpg"
        original_image = Image.open(image_path)
        resized_image = original_image.resize((150, 160), Image.BILINEAR)  # Resize image to 200x200
        self.tkinter_image = ImageTk.PhotoImage(resized_image)
        ...
        all5 = Label(root, text="  Skinkraft", font="times 20 bold", foreground="Black", bg='Silver')
        all5.place(x=920, y=400)

        allt5 = Label(root, text="   Rs.1,4900.50", font="times 16 bold", foreground="Black", bg='Silver')
