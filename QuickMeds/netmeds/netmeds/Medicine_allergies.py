...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Allergies", font="times 30 bold", foreground="BLack", bg='White')
        ...
        self.display_images([
            (r"C:\Users\Abhijit\OneDrive\Desktop\pro\metformin.jpeg", 180, 225),
            (r"C:\Users\Abhijit\OneDrive\Desktop\pro\metformin.jpeg", 370, 225),
            (r"C:\Users\Abhijit\OneDrive\Desktop\pro\metformin.jpeg", 550, 225),
            (r"C:\Users\Abhijit\OneDrive\Desktop\pro\metformin.jpeg", 735, 225),
            (r"C:\Users\Abhijit\OneDrive\Desktop\pro\kolcet.jpg", 920, 225)
        ])
        ...
        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=400, y=485)
        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=565, y=485)
        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=750, y=485)
        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=950, y=485)

        # Additional labels for image details
        all1 = Label(root, text=" 1 AL Syrup", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text="   Cetalore", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all3 = Label(root, text=" Montepex-L ", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all4 = Label(root, text="     Cetgel ", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all5 = Label(root, text="   Klocet-10 ", font="times 20 bold", foreground="Black", bg='Silver')
    ...
    def display_images(self, image_list):
        for image_path, x, y in image_list:
            ...
            image_label = Label(root, image=tkinter_image)
            image_label.image = tkinter_image  # Keep a reference to avoid garbage collection
