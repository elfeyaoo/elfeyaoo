...
class DoctorsPage:
    def __init__(self, root):
        ...
        medicine = Label(root, text="Medicines - Bacterial Infection", font="times 30 bold", foreground="BLack", bg='White')
        ...
        all1 = Label(root, text="Micro Chemist", font="times 20 bold", foreground="Black", bg='Silver')
        all1.place(x=180, y=400)

        allt1 = Label(root, text="     Rs. 710.40", font="times 16 bold", foreground="Black", bg='Silver')
        ...
        all2 = Label(root, text="Candid Cream", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all3 = Label(root, text="Symbiotik ", font="times 20 bold", foreground="Black", bg='Silver')
        ...
        all4 = Label(root, text="     API ", font="times 20 bold", foreground="Black", bg='Silver')
        all4.place(x=735, y=400)

        allt4 = Label(root, text="     Rs. 525.92", font="times 16 bold", foreground="Black", bg='Silver')
        allt4.place(x=735, y=445)

        medi = Button(root, text="Add To cart", bg='white', fg='black', height=1, width=10, font="times 12 bold")
        medi.place(x=755, y=485)

        image_path = r"C:\Users\Abhijit\OneDrive\Desktop\pro\kolcet.jpg"
        original_image = Image.open(image_path)
        resized_image = original_image.resize((150, 160), Image.BILINEAR)  # Resize image to 200x200
        self.tkinter_image = ImageTk.PhotoImage(resized_image)
        ...
        allt5 = Label(root, text="     Rs. 145.30", font="times 16 bold", foreground="Black", bg='Silver')
