...
private void fetchCanteenData() {
    try {
        ...
        ResultSet resultSet = statement.executeQuery("SELECT * FROM canteen1");
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Swis721 BlkCn BT", 0, 36)); // NOI18N
        jLabel4.setText("CANTEEN 1");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(430, 100, 180, 30);
